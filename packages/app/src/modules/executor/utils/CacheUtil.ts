 ...
 */
export const fetchNginxConfigArgs = (nginxInfo: string, cacheManager: Cache): Promise<NginxConfig> => {
   console.log('nginxInfo', nginxInfo)
   // 获取 nginx 版本号
   ...
   return cacheManager.set<NginxConfig>(
